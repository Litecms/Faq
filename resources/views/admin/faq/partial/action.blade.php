                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu item" role="menu">
                            ...
                            data-title='Add Task'  data-url="{{guard_url('faq/faq/action/task/'.$faq->getRouteKey())}}" data-target="#action-modal"><i class="fa fa-fw fa-tasks" aria-hidden="true"></i> Add Task</a></li>

                            <li><a class="action-modal" style="cursor:pointer;" data-toggle="modal" 
                            data-title='Add Calendar'  data-url="{{guard_url('faq/faq/action/calendar/'.$faq->getRouteKey())}}" data-target="#action-modal"><i class="fa fa-fw fa-calendar" aria-hidden="true"></i> Add Calendar</a></li>
                            <li class="divider"></li>

                            <li><a class="action-link" style="cursor:pointer;" data-url="{{guard_url('faq/faq/action/print/'.$faq->getRouteKey())}}"><i class="fa fa-fw fa-print" aria-hidden="true"></i> Print</a></li>

                            <li><a class="action-link" style="cursor:pointer;" data-url="{{guard_url('faq/faq/action/pdf/'.$faq->getRouteKey())}}"><i class="fa fa-fw fa-file-pdf-o" aria-hidden="true"></i> Download PDF</a></li>

                            <li><a class="action-link" style="cursor:pointer;" data-url="{{guard_url('faq/faq/action/excel/'.$faq->getRouteKey())}}"><i class="fa fa-fw fa-file-excel-o" aria-hidden="true"></i> Download Excel</a></li>
                            <li class="divider"></li>

                            <li><a class="action-modal" style="cursor:pointer;" data-toggle="modal" 
                            data-title='Send mail to contact' data-url="{{guard_url('faq/faq/action/mail/'.$faq->getRouteKey())}}" data-target="#action-modal"><i class="fa fa-fw fa-envelope-o" aria-hidden="true"></i> Send Mail</a></li>

                            <li><a class="action-modal" style="cursor:pointer;" data-toggle="modal" 
                            data-title='Send SMS to contact' data-url="{{guard_url('faq/faq/action/sms/'.$faq->getRouteKey())}}" data-target="#action-modal"><i class="fa fa-fw fa-comment-o" aria-hidden="true"></i> Send SMS</a></li>
                            <li class="divider"></li>

                            <li><a class="action-clone" style="cursor:pointer;" data-method="GET" data-title="Clone" data-text="Do you want to duplicate this data?" data-url="{{guard_url('faq/faq/action/copy/'.$faq->getRouteKey())}}"><i class="fa fa-fw fa-clone" aria-hidden="true"></i> Clone</a></li>

                            <li><a class="action-method" data-method="POST" data-title="Archive" data-text="Do you want to change the status of this data?" data-url="{{guard_url('faq/faq/action/status/archive/'.$faq->getRouteKey())}}" style="cursor:pointer;"><i class="fa fa-fw fa-archive" aria-hidden="true"></i> Archive</a></li>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header" style="background-color: #dd4b39; color: #fff;">
                                    ...
                                    <div class="popup_description">For {{$faq->name}}</div>
                                </div>
            ...
            swal({
                ...
                $.ajax({
                    ...
                    success:function(data, textStatus, jqXHR)
                    {
                        ...
                        $('#faq-faq-list').DataTable().ajax.reload( null, false );
                        arrayids = [];
                    },
