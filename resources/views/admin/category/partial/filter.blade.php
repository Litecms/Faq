<div class="btn-group faq-category">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        -> options([''=>'All']+trans('faq::category.options.status'))
                                        ->raw()!!}
                                    </div>
                                </div>
                            </div>
...
$(document).ready(function(){
    ...
    $(".faq-category .btn-open").click(function(){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        $('#open-list').load("{!!guard_url('/settings/setting/search/faq.category.search')!!}");
        $('#modal-open').modal("show");
    });

   $(".faq-category .btn-search").click(function(){
      $('#modal-search').modal("show");
    });
   
    $('.faq-category .btn-save').click(function(e){
        toastr.info('This feature will be enabled soon.', 'Coming soon');
        return false;
        ...
        formData.append('key', 'faq.category.search');
    ...
    $('#btn-apply-search').click( function() {
        ...
        oTable.api().draw();
        $('#faq-category-list .btn-reset-filter').css('display', '');
    ...
    $(".btn-reset-filter").click(function (e) {
        ...
        oTable.api().draw();
        $('#faq-category-list .btn-reset-filter').css('display', 'none');
