    ...
    <div class="dashboard-content">
        <div class="panel panel-color panel-inverse">
            <div class="panel-heading">
                <h3 class="panel-title">Update <span>Faq</span></h3>
            ...
            <div class="panel-body">
                ...
                ->action(trans_url('user/faq/faq') .'/'.$faq->getRouteKey())!!}
                    @include('faq::user.faq.partial.entry')
                                    <div class="row m-t-20">
                                <div class="col-md-12">
                                    <button class="btn btn-sm btn-danger waves-effect w-md waves-light text-uppercase">Update Faq</button>
