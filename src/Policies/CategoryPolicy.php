...
class CategoryPolicy
{
    ...
    {
        if ($user->canDo('faq.category.view') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        if ($user->canDo('faq.category.edit') && $user->isAdmin()) {
            return true;
        }
    ...
    {
        if ($user->canDo('faq.category.verify')) {
            return true;
        }
    ...
    {
        if ($user->canDo('faq.category.approve')) {
            return true;
        }
