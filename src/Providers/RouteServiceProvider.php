...
class RouteServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if (Request::is('*/faq/faq/*')) {
            Route::bind('faq', function ($faq) {
                $faqrepo = $this->app->make('Litecms\Faq\Interfaces\FaqRepositoryInterface');
                return $faqrepo->findorNew($faq);
            });
        }

        if (Request::is('*/faq/category/*')) {
            Route::bind('category', function ($category) {
                $categoryrepo = $this->app->make('Litecms\Faq\Interfaces\CategoryRepositoryInterface');
